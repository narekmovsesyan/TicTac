        ...
        function clikButt(){
            ...
            $('input').click(function(){
                ...
                if($("#"+inputLineId).val()==""){
                    ...
                    if(vars.button1!="" && vars.button2!="" && vars.button3!="" && vars.button4!="" && vars.button5!=""
                        && vars.button6!="" && vars.button7!="" && vars.button8!="" && vars.button9!="")
                    {
...
//                }
        ...
        function logik(){
            ...
            if(a5==""){
            $('#a5').val(computer);
            }else if(5==""&&((a1=="0"&&a9=="0")||(a2=="0"&&a8=="0")||(a3=="0"&&a7=="0")||(a4=="0"&&a6=="0"))){
                $('#a5').val(computer);
